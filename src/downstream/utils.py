...
class WandbLogger(object):
    def __init__(self, project_name="maskdistill-downstream", config=None, name=None, entity=None, wandb_dir=None):
...
def derive_wandb_name_from_checkpoint(checkpoint_path, task_prefix):
    ...
    Example:
        checkpoint: checkpoints/pretrain/pre_v1.moe.64.blck.noshfl.abspos.sparse.cls0.4_25_11_30_02/checkpoint-epoch0299.pth
        -> semseg-eval-E299-pre_v1.moe.64.blck.noshfl.abspos.sparse.cls0.4_25_11_30_02
    """
    import os
    import re
    ...
    # Format: semseg-eval-E299-pre_v1.moe.64.blck...
